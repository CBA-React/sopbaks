...
import { GlobeIcon } from '@/shared/components/CreatePostModal/GlobeIcon';
...
export default function CreateNewPostForm({
    onSuccess,
}: CreateNewPostFormProps): JSX.Element {
    ...
    const handlePost = (): void => {
        console.log('Posting:', { postContent, visibility, uploadedImages });
        ...
        <div className="bg-white">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="font-semibold">Joe Dohn</p>
            ...
            <textarea
                ...
                className="w-full outline-none resize-none text-gray-700 placeholder-gray-400 min-h-[200px] mb-4"
            />
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative" ref={hashtagRef}>
                        ...
                        {isHashtagOpen && (
                            <div className="absolute bottom-full left-0 mb-2 bg-white rounded-lg shadow-lg border border-gray-200 p-3 z-10 min-w-[200px]">
                ...
                <button
                    onClick={handlePost}
                    className="bg-[#C32033] text-white px-12 py-2 rounded-lg hover:bg-[#a01a2a] transition-colors font-medium"
                >
                    Post
                </button>
            </div>
