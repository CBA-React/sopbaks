        ...
        <div className="flex flex-col">
            <label className="flex items-start gap-2">
                <input
                    type="checkbox"
                    {...registration}
                    className="w-4 h-4 text-[#C32033] focus:ring-[#C32033] focus:ring-2 accent-[#C32033] appearance-none border-[1px] border-[#C32033] rounded-sm bg-white checked:bg-[#C32033] checked:border-[#C32033] relative cursor-pointer"
                    style={{
                        backgroundImage:
