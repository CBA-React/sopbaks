...
import UserFollowingSelectedProfile from '@/shared/components/UserFollowingSelectedProfile/UserFollowingSelectedProfile';
...
export default function FollowingSelectedPage(): JSX.Element {
    return (
        <main>
            <section
